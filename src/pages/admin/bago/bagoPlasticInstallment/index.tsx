...
import "react-datepicker/dist/react-datepicker.css";
import { BagoPlasticInstallment } from "@prisma/client";
import { useRouter } from "next/router";

const BagoPlasticInstallments = () => {
  ...
  const [plasticInstall, setPlasticInstall] = useState<
  ...
  useEffect(() => {
    setPlasticInstall(concernBagoInstallment);
  }, [bagoInstallment]);
  let no = 0;
  return (
    <>
...
export default BagoPlasticInstallments;
