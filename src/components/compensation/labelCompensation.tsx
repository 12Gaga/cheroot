...
const LabelCompensation = ({ cheroots }: Props) => {
  return (
    <>
      <Typography
        variant="h6"
      ...
      >
        ...
        <Box sx={{ mt: 2, width: 150 }}>
          <Typography sx={{ fontWeight: "bold" }}>ကျန်ရှိလိပ်</Typography>
          <TextField
            defaultValue={0}
        ...
        <Box sx={{ mt: 2, width: 150 }}>
          <Typography sx={{ fontWeight: "bold" }}>လျော်ပေးလိပ်</Typography>
          <TextField
            defaultValue={0}
        ...
        <Box sx={{ mt: 2, width: 220 }}>
          <Typography sx={{ fontWeight: "bold" }}>ပေးချေရမည့်လိပ်</Typography>
          <TextField
            defaultValue={0}
